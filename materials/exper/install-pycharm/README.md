...
#### 3. 在选择安装窗口中选择PyCharm安装的本地路径，并点击`Next`按钮。
...
#### 10. 在主题选择窗口，选择深色或浅色主题之后，点击`Skip Remaining and Set Defaults`按钮。
...
#### 13. 在如下界面中，在左侧项目结构中右键点击项目名称，依次选择`New`、`Python File`菜单，并在弹出的窗口中输入要创建Python文件的名称，来完成Python文件的创建。
